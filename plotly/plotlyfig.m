classdef plotlyfig < handle
    ...
    methods
        ...
        function obj = update(obj)
            ...
            % find axes of figure
            ax = findobj(obj.State.Figure.Handle,'Type','axes','-or','Type','PolarAxes','-and',{'Tag','','-or','Tag','PlotMatrixBigAx','-or','Tag','PlotMatrixScatterAx', '-or','Tag','PlotMatrixHistAx'});
            ...
            for n = 1:obj.State.Figure.NumAxes
                if ismember(ax(n).Type,specialAxisPlots()), continue; end
